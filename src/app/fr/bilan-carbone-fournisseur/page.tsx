...
export const metadata: Metadata = {
  ...
  openGraph: {
    title:
      "Bilan carbone fournisseur : quoi fournir pour être référencé",
    description:
    ...
    <section className="max-w-7xl mx-auto px-6 pt-12 pb-24">
      ...
      <header className="mb-16">
        ...
        <p className="text-lg text-gray-700 leading-relaxed max-w-3xl">
          De nombreuses PME découvrent l’exigence “bilan carbone fournisseur”
          lors d’un référencement ou d’un renouvellement contractuel.
          Dans la majorité des cas, l’acheteur attend un document de screening ESG
          clair, archivable et comparable — pas un audit carbone complet.
        </p>
      ...
      <section className="mb-16">
        ...
        <div className="mt-6 rounded-2xl border border-gray-200 bg-white p-6">
          <p className="text-gray-700 leading-relaxed">
            L’absence de document bloque souvent davantage qu’un résultat indicatif imparfait.
          </p>
        </div>
      </section>
