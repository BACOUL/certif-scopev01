    ...
    >
      ...
      <div className="mt-16 p-10 rounded-xl bg-white border border-gray-200 shadow-sm">
        ...
        <p className="text-gray-700 text-sm leading-relaxed max-w-4xl">
          Several European regulations indirectly force SMEs to provide environmental indicators. 
          The mechanism works as follows:
        </p>

        <ul className="mt-4 space-y-2 text-gray-700 text-sm leading-relaxed">
          <li>• Large groups subject to <strong>CSRD Article 19a</strong> must disclose climate-related risks.</li>
          <li>• <strong>ESRS E1-9</strong> obliges them to map emissions in the upstream value chain.</li>
          <li>• Banks must assess climate exposure under <strong>SFDR & EBA ESG Risk Guidelines</strong>.</li>
          <li>• Public buyers apply mandatory <strong>Green Public Procurement (GPP)</strong> criteria.</li>
        </ul>
      ...
      <div className="mt-16 p-10 bg-[#F8FAFC] rounded-xl border border-[#15B097]/30 shadow-sm">
        ...
        <ul className="mt-4 space-y-2 text-sm text-gray-700">
          ...
          <li>
            • <a href="https://efrag.org/lab3" target="_blank" className="underline text-[#0B3A63]">
