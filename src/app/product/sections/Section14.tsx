    ...
    >
      ...
      <div className="mt-20 p-10 bg-white border border-gray-200 rounded-xl shadow-md">
        ...
        <ul className="space-y-2 text-gray-700 text-sm leading-relaxed">
          <li>• Classification based on NACE Rev.2 sector mapping</li>
          <li>• Inputs → expenditure categories → sector proxy → CO₂ factor</li>
          <li>• Deterministic, reproducible and compliant with institutional ingestion workflows</li>
          <li>• No custom configuration or sector overrides</li>
        </ul>
      </div>
