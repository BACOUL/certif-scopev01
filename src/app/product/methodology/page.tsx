...
export default function MethodologyPage() {
  return (
    <section className="pt-28 pb-24 bg-white dark:bg-gray-900">
      ...
      {/* HEADER VISUEL IDENTIQUE À PRODUCT OVERVIEW */}
      ...
      <div className="max-w-7xl mx-auto px-6 mt-20">
        ...
        <div className="space-y-24">
          ...
          <div id="s9" className="scroll-mt-28"><Section9 /></div>
          <div id="s10" className="scroll-mt-28"><Section10 /></div>
          <div id="s11" className="scroll-mt-28"><Section11 /></div>
          <div id="s12" className="scroll-mt-28"><Section12 /></div>
        </div>
