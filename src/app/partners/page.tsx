  ...
  return (
    <>
      ...
      <Breadcrumb
        ...
        description="Enterprise integration program for corporations, procurement networks, banks and insurers."
      />
      ...
      >
        ...
        <div className="w-full mb-12">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed max-w-4xl">
            The Certif-Scope Partnership Program enables large corporations, procurement
            networks, banks, insurers and industry platforms to issue CO₂e attestations
            on behalf of their SME suppliers. The integration provides a secure,
            deterministic, verification-ready workflow with automated hash-based
            authenticity checks and client-side data integrity.
          </p>
        </div>
