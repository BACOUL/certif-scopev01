    ...
    <>
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-6">
          ...
          {/* PAGE HEADER */}
          <div className="text-center mb-16 scroll-mt-28">
          ...
          {/* TABLE OF CONTENTS */}
          <div className="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-10 border border-gray-200 dark:border-gray-700 mb-20 scroll-mt-28">
