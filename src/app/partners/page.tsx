    ...
    >
      ...
      >
        <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-[#0B3A63] font-medium">
          <li><a href="#s1">1. Partner Overview</a></li>
          <li><a href="#s2">2. Packs & Credits</a></li>
          <li><a href="#s3">3. Partner Key Issuance</a></li>
          <li><a href="#s4">4. Key Validity & Usage Limits</a></li>
          <li><a href="#s5">5. Recovery & Security Model</a></li>
          <li><a href="#s6">6. API & High-Volume Access (Coming Soon)</a></li>
        </ul>
      </nav>
