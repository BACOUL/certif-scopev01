...
export default function PartnersPage() {
  return (
    <section className="pt-28 pb-24 bg-white dark:bg-gray-900">
      ...
      {/* HEADER VISUEL — uniforme avec les autres pages */}
      <div className="relative w-full h-40 bg-gradient-to-br from-[#EAF3FF] to-[#F8FAFC] dark:from-gray-800 dark:to-gray-900 flex items-center">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 mt-3 max-w-3xl">
            Certif-Scope enables large organizations to issue, verify and distribute
            CO₂e attestations for SME suppliers through deterministic integration and
            automated hash-based verification.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-20">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-10 border border-gray-200 dark:border-gray-700 mb-20">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-gray-700 dark:text-gray-300 text-base leading-relaxed">
            <li><a href="#s1" className="underline hover:text-[#0B3A63]">1. Overview of Partnership Model</a></li>
