...
export default function PricingPage() {
  return (
    ...
    >
      ...
      >
        Fixed price per attestation. No subscription. Validity 1 year. Spend-based
        method with built-in integrity and verification information included in
        every PDF.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        >
          ...
          <p className="text-5xl font-extrabold text-primary mb-1 tracking-tight">
            89€
          </p>
          <p className="text-sm text-gray-500 mb-4">Validity 1 year</p>

          <p className="text-gray-600 dark:text-gray-300 text-sm mb-6 leading-relaxed">
            Instant PDF • Verification QR • Embedded integrity safeguards • Stable
            emission dataset
          </p>
          ...
          <ul className="text-left mx-auto max-w-xs space-y-2 text-gray-700 dark:text-gray-300 text-sm mb-8">
            ...
            <li>• Built-in integrity verification</li>
            <li>• QR link for online or offline validation</li>
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300 text-sm mb-6 leading-relaxed">
            Recommended for accountants, consultants or recurring procurement
            requests.
          </p>
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300 text-sm mb-6 leading-relaxed">
            Ideal for organisations with a steady flow of supplier or banking
            requests.
          </p>
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300 text-sm mb-6 leading-relaxed">
            For large groups managing a wide supplier base and predictable annual
            demands.
          </p>
        ...
        >
          ...
          <p className="text-4xl font-extrabold text-gray-400 mb-3 tracking-tight">
            Coming Soon
          </p>

          <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto text-sm leading-relaxed">
            High-volume issuance, automated onboarding and service-level
      ...
      >
        Spend-based indicative calculation only. Validity 1 year. Not audited. Not
        CSRD/ESRS-compliant.
      </p>
    </section>
  );
