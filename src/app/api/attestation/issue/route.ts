...
function stripSectionNumber(input: string) {
  return String(input || "")
    .replace(/^(\s*\d+[\.\)]?\s*)+/u, "")
    .trim();
}
...
function getSectionTitle(
  ...
  return stripSectionNumber(getText(i18n, key, fallback));
}
...
function getLocaleCopy(locale: AttestationLocale) {
  if (locale === "fr") {
    return {
      ...
      statusValue3: "Dossier fournisseur · Client · Banque · Assurance",
      ...
      scopeNote:
        "Ce document ne constitue ni un inventaire de gaz à effet de serre, ni un audit, ni une vérification, ni une déclaration réglementaire au sens de la CSRD, des ESRS ou de tout autre cadre équivalent.",
...
<body>
  <div class="page page-one">
    ...
    <div class="footer">
      ...
      <div>${escapeHtml(
        getText(i18n, "footerPageLabel", copy.footerPageLabel)
      )} 1 / 2</div>
    </div>
  </div>
    ...
    <div class="content">
      ...
      <div class="card">
        <h2 class="card-title"><span class="section-number">6.</span>${escapeHtml(
          getSectionTitle(i18n, "methodologyTitle", copy.methodologyTitle)
        )}</h2>
      ...
      <div class="card soft">
        <h2 class="card-title"><span class="section-number">7.</span>${escapeHtml(
          getSectionTitle(i18n, "referencesTitle", copy.referencesTitle)
        )}</h2>
        <p class="card-text">${escapeHtml(
      ...
      <div class="card tint">
        <h2 class="card-title"><span class="section-number">9.</span>${escapeHtml(
          getSectionTitle(i18n, "perimeterLimitsTitle", copy.perimeterLimitsTitle)
        )}</h2>
        <p class="card-text">${escapeHtml(
      ...
      <div class="card final">
        <h2 class="card-title"><span class="section-number">10.</span>${escapeHtml(
          getSectionTitle(i18n, "conclusionTitle", copy.conclusionTitle)
        )}</h2>
        <p class="card-text">${escapeHtml(
