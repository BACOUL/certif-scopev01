  ...
  try {
    ...
    const verificationDisplayUrl =
      locale === "fr"
        ...
        : `https://www.certif-scope.com/${locale === "de" ? "verify" : "verify"}`;
  ...
  <div class="page page-one">
    <div class="page-main">
      ...
      <div class="section-card tint dense">
        <h2 class="section-title">${i18n.referencesSectionTitle
          ? "FONDEMENT MÉTHODOLOGIQUE"
          : "FONDEMENT MÉTHODOLOGIQUE"}</h2>
        <p class="plain-text">${i18n.documentNatureText}</p>
      </div>

      <div class="section-card dense">
        <h2 class="section-title">${i18n.documentScopeSummaryTitle}</h2>
      ...
      <div class="feature-strip">
        <div class="feature-card">
          ...
          <div class="feature-text">
            <ul>
              <li>${i18n.privacyText}</li>
              <li>${i18n.documentScopeSummaryText}</li>
              <li>${i18n.authenticityOverviewText}</li>
            </ul>
          </div>
        </div>
    ...
    <div class="page-main">
      ...
      <div class="section-card dense">
        ...
        <div class="formula-box">
          ${copy.formulaTitle} · Dépenses agrégées déclarées × facteurs d’émission monétaires = estimation CO₂e indicative
        </div>

        <div class="mini-grid">
          <div class="mini-pill">
            <span class="mini-label">${i18n.factorVersion ? i18n.factorVersion : "Version des facteurs"}</span>
