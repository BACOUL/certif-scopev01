...
// Paste only the base64 content of your logo her";
...
<div class="container">
  ...
  <!-- Controlled page break to start Page 2 -->
  ...
  <div class="two-col">
    <div>
      ...
      <!-- 7 Methodology and limitations (compacted) -->
    ...
    <aside>
      <!-- Right column on page 2 can remain empty or contain small notes if needed -->
    </aside>
  </div>
