 ...
 * LOGO BASE64
 * ======================================================
 * Colle ton logo base64 ENTRE les deux lignes ci-dessous.
 *
 * IMPORTANT :
 * - Ne mets pas de guillemets.
 * - Ne mets pas const.
 * - Ne mets pas de point-virgule.
 * - Colle uniquement le texte base64 brut.
 *
 * Exemple :
 *
 * const RAW_CERTIF_SCOPE_LOGO_BASE64 = String.raw`
...
const HAS_EMBEDDED_LOGO =
  ...
  !CERTIF_SCOPE_LOGO_BASE64.includes("COLLE_TON_BASE64_ICI");
...
function getLocaleCopy(locale: AttestationLocale) {
  ...
  if (locale === "de") {
    return {
      ...
      documentEyebrow: "INDIKATIVES CO₂e-DOKUMENT · STANDARDISIERT · VERIFIZIERBAR",
      standardReference:
  ...
  return {
    ...
    subtitle:
      "Non-regulatory · Methodology-based · Indicative attestation",
    ...
    <div class="content">
      ...
      <div class="card">
        <h2 class="card-title">1. ${escapeHtml(
          stripLeadingNumber(
            getText(externalI18n, "entitySectionTitle", copy.entitySectionTitle)
          )
        )}</h2>
      ...
      <div class="two-col">
        ...
        <div class="card soft">
          <h2 class="card-title">3. ${escapeHtml(
            stripLeadingNumber(
              getText(externalI18n, "scopeSectionTitle", copy.scopeSectionTitle)
            )
          )}</h2>
          <p class="card-text">${escapeHtml(
