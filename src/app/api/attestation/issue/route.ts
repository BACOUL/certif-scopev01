    ...
    <div>
      ...
      <section aria-labelledby="s3">
        ...
        <div class="meta-list">
          ...
          <div class="row"><strong>Entity identifier:</strong> ${metadata.entityIdentifier}</div>
