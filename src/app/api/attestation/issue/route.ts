...
LOGO
❌ AUCUN BASE64
→ Logo désactivé volontairement
→ Le layout reste strictement identique
==============================================================================
*/
...
<style>
  ...
  .issuer { max-width: 65%; }
  .issuer-name { font-size: 12px; font-weight: 600; }
  .issuer-role { font-size: 10px; color: #374151; }
  .issuer-meta { font-size: 9px; color: #6b7280; margin-top: 4px; }
  .qr { text-align: center; font-size: 8.5px; color: #6b7280; }
  .qr img { width: 64px; height: 64px; margin-bottom: 4px; }
...
<div class="result-box">
  <div class="block-title">Estimated total emissions</div>
  <div class="result-value">${totalCO2e}</div>
  <div>tCO₂e (indicative)</div>
</div>
...
<div class="grid-2">
  <div>
    ...
    <ul>
      ...
      <li>No Scope 1 or Scope 2</li>
      <li>Indicative model</li>
    </ul>
  </div>
...
<div class="footer">
  ...
  a GHG inventory, or a verified statement. Data responsibility lies with the entity.
</div>
