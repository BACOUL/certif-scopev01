 ...
 * LOGO BASE64
 * ======================================================
 * Colle ton logo Certif-Scope encodé en base64 PNG
 * entre les deux backticks ci-dessous.
 *
 * Ne colle PAS :
 ...
 * - point-virgule
 *
 * Colle uniquement le contenu base64 brut.
 */
...
export async function GET(req: Request) {
  try {
    ...
    const verifiableObjectItems = getList(
      externalI18n,
      "verifiableObjectItems",
      copy.verifiableObjectItems
    );
    ...
    <div class="content">
      <div class="page-two-flow">
        ...
        <div class="card tech-card">
          <h2 class="card-title">8. ${escapeHtml(
            stripLeadingNumber(
              getText(
                externalI18n,
