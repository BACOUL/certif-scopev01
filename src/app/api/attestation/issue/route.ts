...
export async function GET(req: Request) {
  try {
    ...
    // HTML (A4-safe CSS, header uses logo only — issuerName removed from header text)
    const html = `
<!doctype html>
<html lang="en">
<head>
...
<style>
  ...
  section { margin-bottom: 10px; padding-right:2px; } /* reduced from 12px */
  ...
  .final-stamp {
    ...
    color: #222;
    background: #fff;
    font-size: 9.8px;         /* was 10.5px */
    line-height: 1.32;        /* added */
  }
...
<div class="container">
  ...
  <!-- Result emphasized and centered (one secondary line removed earlier) -->
  ...
  <div class="two-col">
    <div>
      ...
      <!-- 7 Methodology and limitations (compacted list) -->
    ...
    <aside>
      ...
      <!-- 9 Final clauses and liability (stamp-like, one sentence removed) -->
