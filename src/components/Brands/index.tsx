      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-wrap justify-center items-center gap-12">
          ...
          <div className="flex flex-col items-center gap-3">
            <svg className="h-10 w-10 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 2l7 4v6c0 5-3.5 9-7 10-3.5-1-7-5-7-10V6l7-4z" />
            </svg>
            <span className="text-gray-600 dark:text-gray-300 text-sm font-medium">Compliance</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <span className="text-gray-600 dark:text-gray-300 text-sm font-medium">Banking</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <span className="text-gray-600 dark:text-gray-300 text-sm font-medium">Audit</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <span className="text-gray-600 dark:text-gray-300 text-sm font-medium">Logistics</span>
          </div>
