      ...
      <div className="w-full px-5 py-2 md:py-4 flex items-center justify-between">
        ...
        >
          <ul className="flex flex-col lg:flex-row gap-4 lg:gap-10">
            ...
            <li>
              <Link
                ...
                className={`font-medium ${
                  pathname === "/fr" ? "text-primary" : "text-gray-800 dark:text-gray-200"
                }`}
              >
                Home
              </Link>
            ...
            <li className="relative">
              ...
              {dropdown && (
                <div
                  ...
                  "
                >
                  <Link href="/fr/product" onClick={closeAll} role="menuitem" className="block py-2 text-sm hover:text-primary">
                    Overview
                  </Link>
                  <Link href="/fr/product/methodology" onClick={closeAll} role="menuitem" className="block py-2 text-sm hover:text-primary">
                    Methodology
                  </Link>
                  <Link href="/fr/product/methodology/compliance" onClick={closeAll} role="menuitem" className="block py-2 text-sm hover:text-primary">
                    Compliance
                  </Link>
                </div>
              )}
            ...
            <li><Link href="/fr/verify" onClick={closeAll}>Verify Attestation</Link></li>
            <li><Link href="/fr/pricing" onClick={closeAll}>Pricing</Link></li>
            <li><Link href="/fr/partners" onClick={closeAll}>Partnerships</Link></li>
            <li><Link href="/fr/generate" onClick={closeAll}>Generate Attestation</Link></li>
