...
function trackAnalyzerStart() {
  try {
    track("diagnostic_started", { location: "home" });
  } catch {
    // La navigation ne dépend jamais de la disponibilité des analytics.
  }
}
  ...
  return (
    ...
    >
      <span className="sr-only" itemProp="alternativeHeadline">
        Analysez gratuitement la demande carbone reçue avant de choisir le
      ...
      <div className="mx-auto max-w-7xl px-6 pb-14 pt-8 md:px-8 md:pb-20 md:pt-14">
        <div className="grid items-center gap-10 lg:grid-cols-[0.96fr_1.04fr] lg:gap-14">
          <div className="text-center lg:text-left">
            ...
            >
              Collez gratuitement la demande reçue. Certif-Scope identifie ce
              qu’il faut fournir et vous propose l’attestation CO₂e uniquement
              lorsqu’elle semble adaptée.
            </p>
            ...
            <div className="hero-reveal mt-8 flex flex-col items-center justify-center gap-3 [animation-delay:320ms] sm:flex-row lg:justify-start">
              ...
              <a
                ...
                aria-label="Voir un exemple d’attestation CO₂e"
