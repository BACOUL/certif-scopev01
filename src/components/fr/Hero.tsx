...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 top-0 -z-10 h-[420px] bg-[radial-gradient(circle_at_top,rgba(21,176,151,0.08),transparent_55%)]" />
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="text-center lg:text-left">
            ...
            >
              Bilan carbone PME :
              <br />
              prêt en <span className="text-[#15B097]">quelques minutes</span>
            </h1>
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center lg:justify-start gap-2.5">
              <span className="rounded-full bg-white px-3 py-1.5 text-xs md:text-sm font-medium text-[#0B3A63] border border-[#15B097]/20">
                Prix fixe
              </span>
              <span className="rounded-full bg-white px-3 py-1.5 text-xs md:text-sm font-medium text-[#0B3A63] border border-[#15B097]/20">
                Sans abonnement
