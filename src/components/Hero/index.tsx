...
export default function Hero() {
  return (
    ...
    >
      {/* BACKGROUND GRADIENT */}
      <div className="absolute inset-0 -z-10 bg-gradient-to-b from-white to-[#F3FBFC]" />
      ...
      <div className="flex justify-center mt-12">
        <Image
          ...
          alt="Official CO₂e Attestation preview generated by Certif-Scope"
          width={900}
          height={600}
          priority
          className="w-full max-w-md md:max-w-2xl rounded-2xl shadow-lg border border-slate-100"
        />
      </div>
      ...
      <div className="mt-10 flex flex-col md:flex-row justify-center gap-6">
        ...
        <a
          href="/sample-pdf"
          className="bg-white border border-[#0B3A63] text-[#0B3A63] hover:bg-[#0B3A63] hover:text-white font-semibold px-12 py-4 rounded-xl shadow-md text-center transition"
        >
          View Sample
        </a>
      </div>
