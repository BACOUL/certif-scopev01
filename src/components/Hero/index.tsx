  ...
  return (
    <section className="relative max-w-6xl mx-auto px-6 pt-28 pb-20 text-center">
      ...
      <p className="text-base md:text-lg text-[#475569] max-w-2xl mx-auto mt-6 leading-relaxed">
        Generate a transparent, standardized and non-regulatory CO₂e attestation based 
        exclusively on financial spending (€). Not a CSRD/ESRS report. 
        No Scope 1 or Scope 2 calculations. Suitable for supplier screening, 
