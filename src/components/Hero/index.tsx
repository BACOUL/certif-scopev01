  ...
  return (
    <section className="relative max-w-6xl mx-auto px-6 pt-20 pb-24 text-center">
      ...
      <h1 className="text-3xl md:text-5xl font-black text-[#0B3A63] leading-snug tracking-tight">
        ...
        <span className="text-[#1FB6C1] text-3xl md:text-5xl">for SMEs</span>
      </h1>

      {/* SUBTEXT */}
      <p className="text-base md:text-xl text-[#475569] max-w-3xl mx-auto mt-6 leading-relaxed">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-6 mt-12">
        <a
          href="#assessment"
          className="bg-[#1FB6C1] hover:bg-[#19a8ae] transition text-white font-bold px-12 py-4 rounded-xl shadow-lg text-base md:text-lg"
        >
        ...
        <a
          href="/verify"
          className="bg-[#0B3A63] hover:bg-[#082d4f] transition text-white font-bold px-12 py-4 rounded-xl shadow-lg text-base md:text-lg"
        >
          Verify Attestation
        </a>
      </div>
