    ...
    <section className="py-24 bg-white dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <p className="mt-6 text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
          ...
          procurement and financial ESG pre-assessment — based exclusively on spend-based methodology.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-14">
          ...
          <div className="max-w-xs mx-auto flex flex-col items-center">
            ...
            <p className="mt-3 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              ...
              <span className="block mt-2 text-xs text-gray-500">
                Ensures reproducible output with versioned emission factors.
              </span>
            </p>
          </div>
          ...
          <div className="max-w-xs mx-auto flex flex-col items-center">
            ...
            <p className="mt-3 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              Generate a fully structured CO₂e estimation in seconds — no physical data, no consultants, no delays.
              <span className="block mt-2 text-xs text-gray-500">
                Ideal for high-volume supplier screening processes.
              </span>
            </p>
          </div>
          ...
          <div className="max-w-xs mx-auto flex flex-col items-center">
            ...
            <h3 className="text-xl font-semibold text-[#0B3A63] dark:text-white">
              Verifiable & widely compatible
            </h3>
            <p className="mt-3 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              Each attestation contains a unique verification ID allowing instant integrity checks — 
              commonly used by banking, procurement and insurance teams.
              <span className="block mt-2 text-xs text-gray-500">
                Enables reproducibility and independent verification of authenticity.
              </span>
            </p>
          </div>
        ...
        <p className="mt-16 text-sm md:text-base text-gray-600 dark:text-gray-400 max-w-xl mx-auto">
          Already used across Europe as a fast, consistent and verifiable CO₂e information format for suppliers.
        </p>
