    ...
    <section className="py-24 bg-white dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <p className="mt-6 text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
          Certif-Scope makes CO₂e requests simple. When a client, bank or partner asks for “your carbon data”, you can respond in minutes — not weeks. 
          No consultant, no technical knowledge, no complex reporting: just enter your spending and download a clean, verifiable document.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-14">
          ...
          <div className="max-w-xs mx-auto flex flex-col items-center">
            ...
            <p className="mt-3 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              ...
              <span className="block mt-2 text-xs text-gray-500">
                Looks professional and reduces follow-up questions.
              </span>
            </p>
          </div>
          ...
          <div className="max-w-xs mx-auto flex flex-col items-center">
            ...
            <p className="mt-3 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              ...
              <span className="block mt-2 text-xs text-gray-500">
                No expertise or manual calculation required.
              </span>
            </p>
          </div>
          ...
          <div className="max-w-xs mx-auto flex flex-col items-center">
            ...
            <h3 className="text-xl font-semibold text-[#0B3A63] dark:text-white">
              Trusted & easy to verify
            </h3>
            <p className="mt-3 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              Every document includes a verification ID partners can check instantly.
              <span className="block mt-2 text-xs text-gray-500">
        ...
        <p className="mt-16 text-sm md:text-base text-gray-600 dark:text-gray-400 max-w-xl mx-auto">
          Certif-Scope enables SMEs to respond quickly and professionally with a clear, spend-based indicative document that partners can verify instantly.
        </p>
