  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        {/* DESCRIPTION — unique, non redondante */}
        <p
        ...
        >
          This is the exact standardized layout produced by Certif-Scope. It includes CO₂e totals,
          category breakdown, dataset version, timestamp and a unique verification ID. The format
          is aligned with procurement, banking, insurer and supplier onboarding requirements,
          ensuring clear and fast review.
        </p>
        ...
        <div className="flex justify-center">
          <div className="relative w-full max-w-[600px]">
            <Image
              src="/preview.webp"
              alt="Preview of the official Certif-Scope CO₂e Attestation document"
              width={1200}
              height={800}
              loading="lazy"
