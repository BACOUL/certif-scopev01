  ...
  return (
    <section className="py-24 bg-[#F8FAFC] dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        {/* SECTION LABEL — concise, IA-friendly */}
        ...
        <h2 className="text-2xl md:text-3xl font-extrabold text-[#0B3A63] dark:text-gray-100 leading-tight mb-6">
          Preview of the Official CO₂e Attestation Generated by Certif-Scope
        </h2>

        {/* DESCRIPTION — no overlap with Features or Trust */}
        <p className="text-base md:text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed mb-16">
          This is the exact standardized format delivered when you generate your CO₂e Attestation.
          It includes total emissions, category breakdown, dataset version, timestamp and a unique
          verification ID. Structured for procurement, banking reviews, insurer screening and
        ...
        <div className="flex justify-center">
          <div className="relative w-full max-w-[600px]">
            <Image
              src="/preview.webp"
              alt="Preview of the official CO₂e Attestation format"
              width={1200}
              height={800}
              loading="lazy"
